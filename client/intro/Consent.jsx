    ...
    return (
      <Centered>
        <div className="consent">
          <h1> Consent Form </h1>
          <p>
            This experiment is part of an UPenn scientific project. You will be 
            learning several different pieces of knowledge that you will need 
            to complete a problem at the end of the experiment.
